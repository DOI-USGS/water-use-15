...
- Restructured the end of the page into stacked Data Collection, References (alphabetical, name-based citations), and USGS Vizlab authorship sections, matching other Vizlab sites
- Switched the page font to Source Sans 3, made headings bold, enlarged the page title, and added published and last-updated dates to the authorship section
- Unified layout across the page: one 700px text column, one 960px figure width, consistent heading levels, type scale, paragraph rhythm, and section spacing
